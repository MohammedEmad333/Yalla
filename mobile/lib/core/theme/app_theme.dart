...
ThemeData buildYallaTheme([Brightness brightness = Brightness.light]) {
  ...
  final scheme = ColorScheme.fromSeed(
    ...
    surfaceContainerLowest: YallaColors.surface,
    surfaceContainerLow: YallaColors.card,
    surfaceContainer: YallaColors.surfaceContainer,
    surfaceContainerHigh: YallaColors.surfaceContainer,
    surfaceContainerHighest: YallaColors.surfaceContainer,
