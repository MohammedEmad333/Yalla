...
// الحدّ الأدنى لأجرة أي طلب = ٨ شيكل (Card 69) — يمنع أي طلب أقل من هذا السعر
const MIN_FARE = 8;

// ── Card 89: عرض لفترة محدودة — سقف السعر ١٠ شيكل ─────────────────────────────
// خلال فترة العرض، أيّ طلب سعره التقريبي أكبر من ١٠ شيكل يُخفَّض إلى ١٠ شيكل، ويُعرض
// السعر الأصلي مشطوبًا في التطبيق. العرض صالح حتى نهاية يوم ٢٠٢٦/١٠/١.
const OFFER_PRICE_CAP = 10;
 ...
 * Card 89: نطبّق عرض السقف (١٠ شيكل) على السعر ونُرفق السعر الأصلي وحالة العرض
