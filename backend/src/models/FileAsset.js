...
// القرص المحلّي. سبب وجوده: استضافة الخادم المجانية (Render Free) تستخدم قرصًا
// مؤقّتًا (ephemeral) يُمحى عند كلّ إعادة تشغيل/نشر — فتختفي الصور الشخصية
// "بعد فترة" (Card 102). أمّا قاعدة البيانات (MongoDB المستضافة على Oracle
// Always Free) فدائمة، فتبقى الصورة. حجم الصور الشخصية صغير (بحدّ 5MB لكلّ
// صورة، وغالبًا أقلّ) فلا يقترب من حدود التخزين المجانية.
